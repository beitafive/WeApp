...
Page({
  data: {
    ...
    height: '600px',
    route: '',
    navList: [{ title: '拼车', img: 'http://img.zhudou.cn/guli/carpool/icon/menu/bottom/carpool-01.png', route: '/pages/carpool/index/index' }, { title: '发布', img: 'http://img.zhudou.cn/guli/carpool/icon/menu/bottom/publish-00.png', route: '/pages/carpool/issue/issue' }, { title: '我的', img: 'http://img.zhudou.cn/guli/carpool/icon/menu/bottom/mine-00.png', route: '/pages/carpool/mylist/mylist' }, { title: '主页', img: 'http://img.zhudou.cn/guli/carpool/icon/menu/bottom/zhuye-00.png', route: '/pages/home/home' }]
    },
      onLoad: function () {
        var that = this;
        that.setData({
    ...
    getBanner(){
      var that = this;
      app.globalFun.http('advert/list', { direction: 'asc',position:10 }, (res) => {
        if (res.code == 0) {
